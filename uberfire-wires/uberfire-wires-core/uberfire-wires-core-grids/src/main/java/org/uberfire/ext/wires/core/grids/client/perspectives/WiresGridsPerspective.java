 ...
 */
@ApplicationScoped
@WorkbenchPerspective(identifier = "WiresGridsPerspective")
public class WiresGridsPerspective {

    private static final String WIRES = "Wires Grids";

    private static final String WIRES_CANVAS_SCREEN = "WiresGridsScreen";
