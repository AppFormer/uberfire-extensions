...
public class WildflyUserManagementService extends AbstractUserManagementService {
    ...
    Wildfly8UserPropertiesManager userManager;
    Wildfly8GroupPropertiesManager groupManager;

    @Inject
    public WildflyUserManagementService(final Wildfly8UserPropertiesManager userManager,
                                        final Wildfly8GroupPropertiesManager groupManager,
