...
/**
 * These tests create temporary working copy of the "application-users.properties" file as the tests are run using the real wildfly admin api for realm management.
 */
@RunWith(MockitoJUnitRunner.class)
public class Wildfly8UsersPropertiesManagerTest extends BaseWildflyUsersPropertiesManagerTest {

    @Override
    protected String getUsersFileClasspathLocation() {
        return "org/uberfire/ext/security/management/wildfly8/application-users.properties";
    }

    @Override
    protected BaseWildflyUserPropertiesManager getUsersPropertiesManager() {
        return new Wildfly8UserPropertiesManager();
    }
