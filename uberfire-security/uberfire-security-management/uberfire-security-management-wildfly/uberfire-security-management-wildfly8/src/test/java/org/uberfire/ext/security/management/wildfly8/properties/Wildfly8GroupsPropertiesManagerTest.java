...
public class Wildfly8GroupsPropertiesManagerTest extends BaseWildflyGroupsPropertiesManagerTest {

    @Override
    protected String getUsersFileClasspathLocation() {
        return "org/uberfire/ext/security/management/wildfly8/application-roles.properties";
    }

    @Override
    protected BaseWildflyGroupPropertiesManager getGroupPropertiesManager() {
        return new Wildfly8GroupPropertiesManager();
    }
