...
public class EditScreen
    ...
    private List<String> avaliableWorkbenchScreensIds = new ArrayList<String>( );
    ...
    private void getScreensId() {
        ...
        avaliableWorkbenchScreensIds = activityBeansInfo.getAvailableWorkbenchScreensIds();
    }
    ...
    void okButton() {
        ...
        if ( configContext.getComponentProperty( PLACE_NAME_PARAMETER ) == null ) {
            if ( !avaliableWorkbenchScreensIds.isEmpty() ) {
                configContext.setComponentProperty( PLACE_NAME_PARAMETER, avaliableWorkbenchScreensIds.get( 0 ) );
    ...
    private PropertyEditorCategory generateScreenSettingsCategory() {
        ...
        category.withField( new PropertyEditorFieldInfo( PLACE_NAME_PARAMETER,
                                    ...
                                    .withComboValues( avaliableWorkbenchScreensIds )
